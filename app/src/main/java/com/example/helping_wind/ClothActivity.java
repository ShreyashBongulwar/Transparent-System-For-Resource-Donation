...
public class ClothActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle
                (ClothActivity.this, drawerLayout, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close);
        ...
        userAdapter=new UserAdapter(ClothActivity.this,userList);
    ...
    private void readUsers() {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference()
                .child("users");
        Query query = reference.orderByChild("donations/cloth").equalTo("clothes");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (userList.isEmpty()){
                    Toast.makeText(ClothActivity.this, "No users with cloth donation", Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                }
            }
            @Override
